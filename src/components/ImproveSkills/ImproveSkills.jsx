...
const ImproveSkills = () => {
    return (
        <>
        <div className='flex justify-center items-center gap-28 mb-5 mt-14'>
            <img className='w-[500px] h-[450px] -ml-[460px]' src="https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="" />
            <div>
